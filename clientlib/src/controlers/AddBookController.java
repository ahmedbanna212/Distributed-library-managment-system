...
public class AddBookController {
    ...
    public AddBookController(AddBook gui, Registry r) {
        this.gui = gui;
        this.r = r;
     ...
     class getbtnAction implements ActionListener {
        ...
        public void actionPerformed(ActionEvent ae) {
            try {
                ...
                librarianInterface x = (librarianInterface) r.lookup("AddBook");
                ...
                String value6 = gui.getjTextField6().getText();
               
                x.insertBook(value1, value2, value3, value4, value5, value6);
